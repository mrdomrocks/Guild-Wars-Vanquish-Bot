Global $aCaravan_Ascalon_CaravanAscalon_DragonsGulletRoute01[99][2] = [ _
        [-2441, 1199], _
        [-3786, 4261], _
        [-4511, 4941], _
        [-4458, 7103], _
...
Global $aCaravan_Ascalon_CaravanAscalon_DragonsGulletRoute02[99][2] = [ _
        [1460, 5313], _
        [3658, 3807], _
        [4111, 3698], _
        [7390, 3443], _
...
Func VQCaravanAscalon_DragonsGullet()
	...
	_Vanquisher_RunCaravanRoute($aCaravan_Ascalon_CaravanAscalon_DragonsGulletRoute01)

	; reverse
	_Vanquisher_RunCaravanRoute($aCaravan_Ascalon_CaravanAscalon_DragonsGulletRoute02)
EndFunc
