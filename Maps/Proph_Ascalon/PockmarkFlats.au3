...
Global $aProph_Ascalon_PockmarkFlatsRoute01[129][2] = [ _
        [-7392, 21465], _
        [-7315, 18630], _
        [-4508, 18501], _
        [-1377, 17775], _
...
Global $aProph_Ascalon_PockmarkFlatsRoute02[129][2] = [ _
        [1151, -14661], _
        [-3428, -17564], _
        [-6301, -15101], _
        [-7586, -16919], _
...
Func VQPockmarkFlats()
	...
	_Vanquisher_RunVanquishRoute($aProph_Ascalon_PockmarkFlatsRoute01)

	; reverse
	_Vanquisher_RunVanquishRoute($aProph_Ascalon_PockmarkFlatsRoute02)
EndFunc
