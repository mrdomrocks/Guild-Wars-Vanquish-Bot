...
Global $aProph_Maguuma_SageLandsRoute02[98][2] = [ _
        [27730, 9942], _
        [22868, 8518], _
        [20551, 11049], _
        [16465, 9192], _
...
Func VQSageLands()
	...
	_Vanquisher_RunVanquishRoute($aProph_Maguuma_SageLandsRoute01)

	; reverse
	_Vanquisher_RunVanquishRoute($aProph_Maguuma_SageLandsRoute02)
EndFunc
